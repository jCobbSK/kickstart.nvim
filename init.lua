...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'help', 'vim', 'css', 'html', 'javascript' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>fm', vim.lsp.buf.format, 'Format buffer with LSP')
end
...
vim.keymap.set('t', '<esc>', [[<C-\><C-n>]], { desc = "close toggle terminal" })
